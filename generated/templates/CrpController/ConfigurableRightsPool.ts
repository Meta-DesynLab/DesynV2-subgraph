...
export class ConfigurableRightsPool__etfStatusResult {
  ...
  getCollectPeriod(): BigInt {
    return this.value0;
  }

  getCollectEndTime(): BigInt {
    return this.value1;
  }

  getClosurePeriod(): BigInt {
    return this.value2;
  }

  getClosureEndTime(): BigInt {
    return this.value3;
  }
  ...
  getPerfermanceFee(): BigInt {
    return this.value9;
  }

  getStartClaimFeeTime(): BigInt {
    return this.value10;
  }
}
...
export class ConfigurableRightsPool extends ethereum.SmartContract {
  ...
  beginFundAssets(): ConfigurableRightsPool__beginFundAssetsResultValue0Struct {
    ...
    return changetype<ConfigurableRightsPool__beginFundAssetsResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_beginFundAssets(): ethereum.CallResult<ConfigurableRightsPool__beginFundAssetsResultValue0Struct> {
    let result = super.tryCall(
      "beginFundAssets",
      "beginFundAssets():((uint256,uint256,uint256,address[],uint256[]))",
      [],
    ...
    return ethereum.CallResult.fromValue(
      changetype<ConfigurableRightsPool__beginFundAssetsResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  try_couldClaimManagerFee(): ethereum.CallResult<ConfigurableRightsPool__couldClaimManagerFeeResult> {
    let result = super.tryCall(
      "couldClaimManagerFee",
      "couldClaimManagerFee():(bool,uint256,uint256)",
      [],
  ...
  endFundAssets(): ConfigurableRightsPool__endFundAssetsResultValue0Struct {
    ...
    return changetype<ConfigurableRightsPool__endFundAssetsResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_endFundAssets(): ethereum.CallResult<ConfigurableRightsPool__endFundAssetsResultValue0Struct> {
    let result = super.tryCall(
      "endFundAssets",
      "endFundAssets():((uint256,uint256,uint256,address[],uint256[]))",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<ConfigurableRightsPool__endFundAssetsResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  try_etfStatus(): ethereum.CallResult<ConfigurableRightsPool__etfStatusResult> {
    let result = super.tryCall(
      "etfStatus",
      "etfStatus():(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [],
  ...
  snapshotAssets(): ConfigurableRightsPool__snapshotAssetsResultValue0Struct {
    ...
    return changetype<ConfigurableRightsPool__snapshotAssetsResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_snapshotAssets(): ethereum.CallResult<ConfigurableRightsPool__snapshotAssetsResultValue0Struct> {
    let result = super.tryCall(
      "snapshotAssets",
      "snapshotAssets():((uint256,uint256,uint256,address[],uint256[]))",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<ConfigurableRightsPool__snapshotAssetsResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
...
export class CreatePoolCall__Inputs {
  ...
  get tokenRange(): CreatePoolCallTokenRangeStruct {
    return changetype<CreatePoolCallTokenRangeStruct>(
...
export class InitCall__Inputs {
  ...
  get poolParams(): InitCallPoolParamsStruct {
    return changetype<InitCallPoolParamsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }

  get rightsStruct(): InitCallRightsStructStruct {
    return changetype<InitCallRightsStructStruct>(
...
export class SnapshotAssetsCall__Outputs {
  ...
  get value0(): SnapshotAssetsCallValue0Struct {
    return changetype<SnapshotAssetsCallValue0Struct>(
